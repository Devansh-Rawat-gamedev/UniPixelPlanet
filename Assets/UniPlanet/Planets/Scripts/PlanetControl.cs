...
public class PlanetControl : MonoBehaviour {
    ...
    private IPlanet _planetComp;
    private void Start()
    {
        dd_planets.value = selected_planet;
        dd_planets.onValueChanged.Invoke(selected_planet);
        OnChangeSeedRandom();
        GetColors();
        MakeColorButtons();
    }
    ...
    public void OnSelectPlanet()
    {
        ...
        _planetComp = planets[selected_planet].GetComponent<IPlanet>();
